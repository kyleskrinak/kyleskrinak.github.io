...
The site integrates Cloudflare Web Analytics for privacy-friendly, lightweight traffic monitoring on production only (kyle.skrinak.com).
...
- **Staging**: No token set in staging CI; analytics disabled automatically.
