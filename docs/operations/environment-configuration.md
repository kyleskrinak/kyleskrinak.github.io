...
| `SITE_URL` | (fallback: `https://kyle.skrinak.com/`) | `https://kyleskrinak.github.io/` ✓ | `https://kyle.skrinak.com/` ✓ |
| `PUBLIC_DEPLOY_ENV` | (fallback: `production`) | `staging` ✓ | `production` ✓ |
| `PUBLIC_CLOUDFLARE_ANALYTICS_TOKEN` | (omitted) | `required` ✓ | `required` ✓ |
| `PUBLIC_GOOGLE_ANALYTICS_ID` | (omitted) | (omitted) | `required` ✓ |
...
| Flag | local-develop | staging-gh | main-aws |
|------|----------|----------|----------|
