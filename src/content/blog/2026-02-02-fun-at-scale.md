...
The results were consistent: desktop scores improved by an average of 29 points (58.5 → 87.5), and mobile scores increased by 32 points (56.5 → 88.5). The best performer was my [Vim for Writers](/blog/2017-02-09-vim-for-writers/) post, which went from a 60 on desktop to 98, and from 58 to a perfect 100 on mobile. I found that ironic, as it's a simple light-touch text post.
