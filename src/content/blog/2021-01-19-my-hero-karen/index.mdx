...
description: My squatting calves, trembling and tiptoe, are eager to get me out
  of there. Karen and I agreed &mdash; my only option is for me to jump and for
  Karen to "catch" me.<br/><br/> The two adult men, across the street, continue
  to savor their evening’s spectacle.
categories: []
---

import { Image } from "astro:assets";
import img_88_walnut_roof from "./88-walnut-roof.webp";
...
<figure class="figure">
<Image src={img_88_walnut_roof} alt="My perch, 40-some years ago, after some significant renovation, and shrubs." class="figure__image" />
